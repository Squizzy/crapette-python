...
class StacksLayoutUI:
    ...
    # def __init__(self, logger: GameLogger, cards: CardsUI, ui_game_state: UIGameState) -> None:
        ...
        # self._margin_x = self._ui_game_state.card_width // 7
        # self._margin_y = self._ui_game_state.card_height // 7
    ...
    #     player_center_x = self._ui_game_state.window_centre_x - self._ui_game_state.card_width // 2
    #     player_left_x = player_center_x - self._ui_game_state.card_width - self._margin_x
    #     player_right_x = player_center_x + self._ui_game_state.card_width + self._margin_x
    #     player_foundation_x = self._ui_game_state.window_centre_x + self._margin_x
    #     player_tableau_x = player_foundation_x + self._margin_x + self._ui_game_state.card_height
    ...
    #     opponent_center_x = self._ui_game_state.window_centre_x - self._ui_game_state.card_width // 2
    #     opponent_left_x = opponent_center_x - self._ui_game_state.card_width - self._margin_x
    #     opponent_right_x = opponent_center_x + self._ui_game_state.card_width + self._margin_x
    #     opponent_foundation_x = self._ui_game_state.window_centre_x - self._margin_x - self._ui_game_state.card_height
    #     opponent_tableau_x = opponent_foundation_x - self._margin_x - self._ui_game_state.card_width
    ...
    #     opponent_y = self._ui_game_state.window_centre_y - self._ui_game_state.card_height * 3 - int(self._margin_y * 2.5)
    #     player_y = self._ui_game_state.window_centre_y + self._ui_game_state.card_height * 2 + int(self._margin_y * 2.5)
    #     tableau_top_y = self._ui_game_state.window_centre_y - self._ui_game_state.card_height * 2 - int(self._margin_y * 1.5)
    #     foundation_top_y = tableau_top_y + (self._ui_game_state.card_height - self._ui_game_state.card_width) //2
    #     tableau_spacing_y = self._ui_game_state.card_height + self._margin_y
    ...
    #     # self._ui_game_state.window_centre_x = self._screen_width // 2
    #     # self._ui_game_state.window_centre_y = self._screen_height // 2
