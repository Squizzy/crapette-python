...
p1crapette:CrapetteStack = CrapetteStack(p1deck)
...
print("### - Add card3")
p1crapette.add_card(card3)
for card in p1crapette_cards:
    print(card)

print("### - Add card4")
p1crapette.add_card(card4)
for card in p1crapette_cards:
    print(card)

print("### - Create Tableau")
tableau: TableauStacks = TableauStacks(p1deck)
